...
class MainActivity : AppCompatActivity() {
    ...
    val API: String = "4621e355b8fa925775c8e8fbb00c684f"
    ...
    inner class weatherTask(): AsyncTask<String, Void, String>(){
        ...
        var response:String?
        try {
            response = URL("https://api.openweathermap.org/data/3.0/onecall?lat=33.44&lon=-94.04&exclude=hourly,daily&appid={4621e355b8fa925775c8e8fbb00c684f}").readText(Charsets.UTF_8)
